...
try:
    ...
    while not cond:
        print(
            "\nChoose action:\n0.Create table\n1.Add user and score\n2.Change score of existing user\n3.Delete user\n4.Find score by name\n5.Show all names and scores\n6.Exit")
        action = input()
        if action == '1':
            print("Insert data")
            add_user()
...
def game_loop():
    ...
    snake_List = []
    length_of_snake = 1
    food_timer = pygame.time.get_ticks() + 9000
    food_timer1 = pygame.time.get_ticks() + 9000
    food_timer3 = pygame.time.get_ticks() + 9000
